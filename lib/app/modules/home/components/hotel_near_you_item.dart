    ...
    return InkWell(
     ...
     GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        var itemData=controller.getposts[index];
        return Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(
                         itemData.featuredHotels![index].thumbnail.toString()
                        ),
                      fit: BoxFit.cover
                    ),
              ...
              Spacer(),
              Text(
                itemData.featuredHotels![index].title.toString(),
                // 'titile',
              ...
              Row(
                children: [
                  RatingBarIndicator(
                    // rating: 3.3,
                    rating: double.parse(itemData.featuredHotels![index].avgReviews!.totalReviews.toString()),
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: "\$${itemData.featuredHotels![index].price.toString()}/",
                          // text: "\$49/",
                          style: _textStyle.copyWith(
